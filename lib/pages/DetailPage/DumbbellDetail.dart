...
class DumbbellDetail extends StatefulWidget {
  const DumbbellDetail({super.key});

  @override
  State<DumbbellDetail> createState() => _DumbbellDetailState();
}

class _DumbbellDetailState extends State<DumbbellDetail> {
  @override
  Widget build(BuildContext context) {
    final productsProvider = Provider.of<ProductsProvider>(context);
    final cartProvider = Provider.of<CartProvider>(context, listen: true);
    final dumbbellProduct = productsProvider.products['dumbbell'];
                    ...
                    child: AppBar(
                      ...
                      actions: [
                        IconButton(
                          onPressed: () {
                            setState(() {
                              dumbbellProduct.isFavorite = !dumbbellProduct.isFavorite;
                            });
                          },
                          icon: dumbbellProduct!.isFavorite
                              ? Icon(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Swiper(
                          itemCount: dumbbellProduct.images.length,
                          itemBuilder: (context, index) {
                            return Image.asset(
                              dumbbellProduct.images[index],
                              fit: BoxFit.cover,
                            );
                          },
                          autoplay: false,
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  dumbbellProduct.price.toString(),
                                  style: TextStyle(
                                      fontSize: 35,
                            ...
                            Container(
                              child: ProductReview(
                                averageStars: 4.6,
                                reviews: dumbbellProduct.reviews,
                              ),
                            )
                          ],
                        ),
                    ...
                    children: [
                      Stack(
                        children: [
                          ...
                          if (cartProvider.items
                                  .where((item) => item.id == dumbbellProduct.id)
                                  .isNotEmpty &&
                              cartProvider.items
                                      .firstWhere((item) => item.id == dumbbellProduct.id)
                                      .quantity >
                                  99)
                            Positioned(
                              right: 0,
                      ...
                      Stack(
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () {
                              cartProvider.addItem(dumbbellProduct);
                            },
                            child: Row(
                              children: [

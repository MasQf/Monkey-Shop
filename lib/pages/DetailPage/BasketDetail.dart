...
class BasketDetail extends StatefulWidget {
  const BasketDetail({super.key});

  @override
  State<BasketDetail> createState() => _BasketDetailState();
}

class _BasketDetailState extends State<BasketDetail> {
  @override
  Widget build(BuildContext context) {
    final productsProvider = Provider.of<ProductsProvider>(context);
    final cartProvider = Provider.of<CartProvider>(context, listen: true);
    final basketProduct = productsProvider.products['basket'];
                    ...
                    child: AppBar(
                      ...
                      actions: [
                        IconButton(
                          onPressed: () {
                            setState(() {
                              basketProduct.isFavorite = !basketProduct.isFavorite;
                            });
                          },
                          icon: basketProduct!.isFavorite
                              ? Icon(
                    ...
                    children: [
                      ...
                      InteractiveViewer(
                        child: Container(
                          ...
                          child: Swiper(
                            itemCount: basketProduct.images.length,
                            itemBuilder: (context, index) {
                              return Image.asset(
                                basketProduct.images[index],
                                fit: BoxFit.cover,
                              );
                            },
                            autoplay: false,
                    ...
                    children: [
                      Stack(
                        children: [
                          ...
                          if (cartProvider.items
                                  .where((item) => item.id == basketProduct.id)
                                  .isNotEmpty &&
                              cartProvider.items
                                      .firstWhere((item) => item.id == basketProduct.id)
                                      .quantity >
                                  99)
                            Positioned(
                              right: 0,
                      ...
                      Stack(
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () {
                              cartProvider.addItem(basketProduct);
                            },
                            child: Row(
                              children: [

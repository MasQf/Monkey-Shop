...
class PlanterDetail extends StatefulWidget {
  const PlanterDetail({super.key});

  @override
  State<PlanterDetail> createState() => _PlanterDetailState();
}

class _PlanterDetailState extends State<PlanterDetail> {
  @override
  Widget build(BuildContext context) {
    final productsProvider = Provider.of<ProductsProvider>(context);
    final cartProvider = Provider.of<CartProvider>(context, listen: true);
    final planterProduct = productsProvider.products['planter'];
                    ...
                    child: AppBar(
                      ...
                      actions: [
                        IconButton(
                          onPressed: () {
                            setState(() {
                              planterProduct.isFavorite = !planterProduct.isFavorite;
                            });
                          },
                          icon: planterProduct!.isFavorite
                              ? Icon(
                    ...
                    children: [
                      ...
                      InteractiveViewer(
                        child: Container(
                          ...
                          child: Swiper(
                            itemCount: planterProduct.images.length,
                            itemBuilder: (context, index) {
                              return Image.asset(
                                planterProduct.images[index],
                                fit: BoxFit.cover,
                              );
                            },
                            autoplay: false,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              child: ProductReview(
                                averageStars: 4.9,
                                reviews: planterProduct.reviews,
                              ),
                            )
                          ],
                        ),
                    ...
                    children: [
                      Stack(
                        children: [
                          ...
                          if (cartProvider.items
                                  .where((item) => item.id == planterProduct.id)
                                  .isNotEmpty &&
                              cartProvider.items
                                      .firstWhere((item) => item.id == planterProduct.id)
                                      .quantity >
                                  99)
                            Positioned(
                              right: 0,
                      ...
                      Stack(
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () {
                              cartProvider.addItem(planterProduct);
                            },
                            child: Row(
                              children: [

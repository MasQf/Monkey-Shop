...
class _TreeDetailState extends State<TreeDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    final treeProduct = productsProvider.products['tree'];
                    ...
                    child: AppBar(
                      ...
                      actions: [
                        IconButton(
                          onPressed: () {
                            setState(() {
                              treeProduct.isFavorite = !treeProduct.isFavorite;
                            });
                          },
                          icon: treeProduct!.isFavorite
                              ? Icon(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Swiper(
                          itemCount: treeProduct.images.length,
                          itemBuilder: (context, index) {
                            return Image.asset(
                              treeProduct.images[index],
                              fit: BoxFit.cover,
                            );
                          },
                          autoplay: false,
                    ...
                    children: [
                      Stack(
                        children: [
                          ...
                          if (cartProvider.items
                                  .where((item) => item.id == treeProduct.id)
                                  .isNotEmpty &&
                              cartProvider.items
                                      .firstWhere((item) => item.id == treeProduct.id)
                                      .quantity >
                                  99)
                            Positioned(
                              right: 0,
                      ...
                      Stack(
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () {
                              cartProvider.addItem(treeProduct);
                            },
                            child: Row(
                              children: [

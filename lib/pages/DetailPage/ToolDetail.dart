...
class _ToolDetailState extends State<ToolDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    final toolProduct = productsProvider.products['tool'];
                    ...
                    child: AppBar(
                      ...
                      actions: [
                        IconButton(
                          onPressed: () {
                            setState(() {
                              toolProduct.isFavorite = !toolProduct.isFavorite;
                            });
                          },
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Swiper(
                          itemCount: toolProduct.images.length,
                          itemBuilder: (context, index) {
                            return Image.asset(
                              toolProduct.images[index],
                              fit: BoxFit.cover,
                            );
                          },
                          autoplay: false,
                    ...
                    children: [
                      Stack(
                        children: [
                          ...
                          if (cartProvider.items
                                  .where((item) => item.id == toolProduct.id)
                                  .isNotEmpty &&
                              cartProvider.items
                                      .firstWhere((item) => item.id == toolProduct.id)
                                      .quantity >
                                  99)
                            Positioned(
                              right: 0,
                      ...
                      Stack(
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () {
                              cartProvider.addItem(toolProduct);
                            },
                            child: Row(
                              children: [

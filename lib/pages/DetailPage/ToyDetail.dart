...
class _ToyDetailState extends State<ToyDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    final toyProduct = productsProvider.products['toy'];
                    ...
                    child: AppBar(
                      ...
                      actions: [
                        IconButton(
                          onPressed: () {
                            setState(() {
                              toyProduct.isFavorite = !toyProduct.isFavorite;
                            });
                          },
                          icon: toyProduct!.isFavorite
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Swiper(
                          itemCount: toyProduct.images.length,
                          itemBuilder: (context, index) {
                            return Image.asset(
                              toyProduct.images[index],
                              fit: BoxFit.cover,
                            );
                          },
                          autoplay: false,
                    ...
                    children: [
                      Stack(
                        children: [
                          ...
                          if (cartProvider.items
                                  .where((item) => item.id == toyProduct.id)
                                  .isNotEmpty &&
                              cartProvider.items
                                      .firstWhere((item) => item.id == toyProduct.id)
                                      .quantity >
                                  99)
                            Positioned(
                              right: 0,
                      ...
                      Stack(
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () {
                              cartProvider.addItem(toyProduct);
                            },
                            child: Row(
                              children: [

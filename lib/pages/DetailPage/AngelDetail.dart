...
class AngelDetail extends StatefulWidget {
  const AngelDetail({super.key});

  @override
  State<AngelDetail> createState() => _AngelDetailState();
}

class _AngelDetailState extends State<AngelDetail> {
  @override
  Widget build(BuildContext context) {
    final productsProvider = Provider.of<ProductsProvider>(context);
    final cartProvider = Provider.of<CartProvider>(context, listen: true);
    final angelProduct = productsProvider.products['angel'];
                    ...
                    child: AppBar(
                      ...
                      actions: [
                        IconButton(
                          onPressed: () {
                            setState(() {
                              angelProduct.isFavorite = !angelProduct.isFavorite;
                            });
                          },
                          icon: angelProduct!.isFavorite
                              ? Icon(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Swiper(
                          itemCount: angelProduct.images.length,
                          itemBuilder: (context, index) {
                            return Image.asset(
                              angelProduct.images[index],
                              fit: BoxFit.cover,
                            );
                          },
                          autoplay: false,
                    ...
                    children: [
                      Stack(
                        children: [
                          ...
                          if (cartProvider.items
                                  .where((item) => item.id == angelProduct.id)
                                  .isNotEmpty &&
                              cartProvider.items
                                      .firstWhere((item) => item.id == angelProduct.id)
                                      .quantity >
                                  99)
                            Positioned(
                              right: 0,
                      ...
                      Stack(
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: () {
                              cartProvider.addItem(angelProduct);
                            },
                            child: Row(
                              children: [
